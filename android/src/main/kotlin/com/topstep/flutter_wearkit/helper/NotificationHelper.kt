...
import com.topstep.flutter_wearkit.R
...
object NotificationHelper {
    ...
    /**
     * NaviService作为前台服务的通知ID
     */
    const val NAVI_SERVICE_NOTIFICATION_ID = 10005
    ...
    fun createSportChannel(context: Context, notificationManager: NotificationManager) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val channel = NotificationChannel(SPORT_CHANNEL_ID, context.getString(R.string.sport_module), NotificationManager.IMPORTANCE_HIGH)
